...
{
    var title = "CO2 Emissions from gas consumption in China"; //default title
    ...
    d3.select('#getData')
        .on('click', () => {
            ...
            if (energySelected != "all") {
                title = "CO2 Emissions from " + energySelected + " consumption in " + countrySelected;//interactive title for bar chart
